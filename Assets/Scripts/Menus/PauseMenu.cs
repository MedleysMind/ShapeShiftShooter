...
/*Game Pause Menu Script
 * Original Source Code falls under the Creative Commons Attribution-ShareAlike 3.0
 * Edited and adapted for specific use by Patrick Medley
 */
...
public class PauseMenu : MonoBehaviour
{
    ...
    public string url = "lightlovemedia.com";

    public Color statColor = Color.yellow;

    public string[] credits = {
        "A Light Love Media Game",
        "Programming by Patrick Medley" +
        "Artwork and UI Design by Jessica Davis",
        "www.lightlovemedia.com",
        "Copyright (c) 2019 Light Love Media"};
    public Texture[] crediticons;

    public enum Page
    {
        None, Main, Options, Credits, Exit
    }
